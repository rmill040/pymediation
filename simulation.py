...
def write_estimates(i = None, N = None, a = None, b = None, c = None, method = None,
					estimator = None, b1 = None, b2 = None, point = None, ll = None,
					ul = None):
	tmp = [i, N, a, b, c, method, estimator, b1, b2, point, ll, ul]
...
def main():
	...
	print('\nSimulation Finished in {0} hours on process {1}\n'.format((timeit.default_timer() - global_start)/3600, rank))
